...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.bpldq05.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const bookingsCollection = client.db('doctorsPotal').collection('bookings')
